...
**MSc Data Science @ Universität Trier | ex-SAP Software Engineer | Building ML systems end-to-end**

## About

I build end-to-end ML systems, from training and experimentation to production deployment. Currently finishing my MSc Data Science at Universität Trier (grade 1.5) after four years of backend engineering at SAP Labs India. Core interests: recommender systems, NLP, MLOps, and reproducible ML research.
